...
/**
 * Servlet implementation class AddResDept
 */
public class AddResDept extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			PreparedStatement s1=con.prepareStatement("insert into resdept values(?,?,?)");
			s1.setInt(1,0);
