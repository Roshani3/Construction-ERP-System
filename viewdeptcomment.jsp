	...
	<div class="content">
		<div class="typography">
			...
			<div class="container">
				...
				<h3 style="background-color:powderblue"><CENTER>VIEW COMMENT</CENTER></h3>
				...
				<div class="bs-docs-example">
					<table class="table table-striped" border="2">
						...
						<%
							...
							PreparedStatement s1=con.prepareStatement("select * from depttaskcomment where deptid=? and tid=?");
