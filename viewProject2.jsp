...
<body>
	...
	<div class="header">
        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
						...
						<li><a href="deptMenu.html">Back <span class="sr-only">(current)</span></a></li>
				...
				<div class="bs-docs-example">
					<table class="table table-striped" border="2">
						...
						<%
							...
							PreparedStatement s1=con.prepareStatement("select * from project");
							    ...
							    <tr>
							      ...
							      <td><%=rs.getString(2)%></td>
							       <td><%=rs.getString(3)%></td>
							        ...
							        <td><a href="viewdepttask.jsp?id=<%=rs.getInt(1) %>">viewTask</a></td>
