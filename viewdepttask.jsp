        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav cl-effect-16">
							...
							<li><a href="deptLogin.html">DepartmentLogin <span class="sr-only">(current)</span></a></li>
	...
	<div class="content">
		<div class="typography">
			...
			<div class="container">
				...
				<h3 style="background-color:powderblue"><CENTER>VIEW DEPARTMENT TASK</CENTER></h3>
				...
				<div class="bs-docs-example">
					<table class="table table-striped" border="2">
						...
						<%
							...
							PreparedStatement s1=con.prepareStatement("select * from depttask where did=? and pid=?");
							int deptid=SetGet.getDid();
							s1.setInt(1, deptid);
							    ...
							    <tr>
							      ...
							      <td><%=rs.getString(4)%></td>
							       ...
							       <td><%=rs.getString(10)%></td>
							          ...
							          <td><a href="adddeptcomment.html">AddCommentOnTask</a></td>
							          <td><a href="viewdeptcomment.jsp">ViewCommentOnTask</a></td>
